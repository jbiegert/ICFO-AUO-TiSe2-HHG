...
genpath = Path(r"D:\Dropbox\TiSe2_CDW\analysis\230504_PolScan\scan06")
...
file_dict, mynames = load_fileToDictionary(genpath,r"dat\scan06_S*.txt") #S* is Spectra
file_dict2, mynames2 = load_fileToDictionary(genpath,r"dat\scan06_W*.txt") #W* is Wavelength
file_dict3, mynames3 = load_fileToDictionary(genpath,r"dat\scan06_P*.txt") #W* is Wavelength
...
# np.savetxt('scan06_168K_HHlineouts.txt',(np.transpose(filetosave)),header='HWP,H3,H3Std,H5,H5Std,H7,H7Std') # not a temp scan!
